RADIO - PONTE EN ONDA				
Descripcion :	La radio "PONTE EN ONDA" por mes de aniversario quiere regalar a todos sus oyentes jóvenes USB de música del momento, por tal motivo, visitara cada zona del Lima metropolitana en una caravana. Para esto la empresa creara una aplicativo para que sus seguidores, que son en su mayoría jóvenes, puedan registrarse vía facebook, y reciban las coordenadas gráficas y la hora exacta que harán su presentación y entrega de regalos.			
...
GITHUB :	https://github.com/pvaleso/PremiosOnda

HEROKU :	http://caravanaonda.herokuapp.com/			